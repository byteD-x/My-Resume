...
export const TimelineItem = React.memo(function TimelineItem({
  ...
  return (
    ...
    >
      ...
      <div className="md:grid md:grid-cols-[11ch_26px_1fr] md:gap-6">
        ...
        <div className="hidden md:flex flex-col items-center">
          {/* Dot */}
          <div
            className={`mt-5 z-10 h-2.5 w-2.5 flex-shrink-0 rounded-full border-2 bg-[rgba(255,255,255,0.95)] transition-colors duration-300 border-[rgba(37,99,235,0.22)] group-hover:border-[rgba(37,99,235,0.45)]`}
          />
        ...
        {/* 3. Content Card */}
        <div className="relative pb-5 md:pb-1">
          {/* Mobile Dot (Absolute) */}
          <div
