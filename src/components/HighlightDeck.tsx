...
export default function HighlightDeck({ items, timeline = [] }: HighlightDeckProps) {
                                ...
                                <motion.button
                                    ...
                                    className={[
                                        ...
                                        isFocal
                                            ...
                                            : 'border-zinc-200/50 bg-white/50 backdrop-blur-md dark:border-zinc-800/50 dark:bg-zinc-900/50',
