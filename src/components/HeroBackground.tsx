    ...
    return (
        <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
            <motion.div
                ...
                className="absolute top-0 right-0 h-[600px] w-[600px] translate-x-1/3 -translate-y-1/4 transform-gpu rounded-full bg-gradient-to-br from-blue-100/40 to-purple-100/40 opacity-40 blur-3xl will-change-transform dark:from-blue-900/20 dark:to-purple-900/20"
