...
export function AppointmentModal({
  ...
  const validateForm = useCallback(() => {
    ...
    if (!formData.name.trim()) {
      newErrors.name = copy.appointment.nameRequired;
      isValid = false;
    } else if (formData.name.length > 50) {
      newErrors.name = copy.appointment.nameTooLong;
      isValid = false;
    }

    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (!formData.email.trim()) {
      newErrors.email = copy.appointment.emailRequired;
      isValid = false;
    } else if (!emailRegex.test(formData.email)) {
      newErrors.email = copy.appointment.emailInvalid;
      isValid = false;
    }

    setErrors(newErrors);
    return isValid;
  }, [copy.appointment.emailInvalid, copy.appointment.emailRequired, copy.appointment.nameRequired, copy.appointment.nameTooLong, formData]);
            ...
            <div className="theme-panel theme-dialog-header px-4 py-4 sm:px-6 sm:py-5">
              <div className="flex items-start justify-between gap-4">
                ...
                <DialogCloseButton
                  ref={closeButtonRef}
                  onClick={onClose}
                  ariaLabel={copy.appointment.close}
                  className="shrink-0"
                  iconSize={20}
                />
              </div>
              ...
              {!isSubmitted ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder={copy.appointment.namePlaceholder}
                      />
                    </div>
                    {errors.name ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        placeholder={copy.appointment.messagePlaceholder}
                      />
                    </div>
                  </div>
                ...
                >
                  ...
                  <h3 className="theme-title mb-2 text-lg font-bold">
                    {copy.appointment.successTitle}
                  </h3>
                  <p className="theme-copy">
                    {copy.appointment.successBody}
                  </p>
                </motion.div>
              )}
            </div>
